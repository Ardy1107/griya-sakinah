...
const FALLBACK_DATA = [
    ...
    { no: 23, tanggal: 'Jumat, 13 Mar', tanggal_date: '2026-03-13', nasi1_donatur: true, nasi2_donatur: true, takjil_nama: 'Pak Pujianto', takjil_blok: 'Kav', minuman_nama: 'Pak M. Fauzi', minuman_blok: 'B-14' },
